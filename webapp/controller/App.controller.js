...
], function (Controller,MessageToast,Log,formatter,Filter,FilterOperator,UIComponent) {
	"use strict";

	return Controller.extend("MyApp.movies.controller.App", {
		formatter: formatter,
		...
		onAppointmentSelect: function(oAppointment){
			...
			UIComponent.getRouterFor(this).navTo("Detail", {movieId:aParameters[2], appointmentId: aParameters[4]});	
